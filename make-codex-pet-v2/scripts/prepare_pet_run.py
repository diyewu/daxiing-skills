...
ROWS = [
    ...
    ("look-000-157-5", 9, 8, "look directions from 0 through 157.5 degrees"),
    ("look-180-337-5", 10, 8, "look directions from 180 through 337.5 degrees"),
]
...
STATE_PROMPTS = {
    ...
    "look-000-157-5": "Eight ordered look-direction poses at 0, 22.5, 45, 67.5, 90, 112.5, 135, and 157.5 degrees.",
    "look-180-337-5": "Eight ordered look-direction poses at 180, 202.5, 225, 247.5, 270, 292.5, 315, and 337.5 degrees.",
}
...
STATE_REQUIREMENTS = {
    ...
    "look-000-157-5": [
        "Treat the frames as ordered directional poses, not an animation loop.",
        "Progress smoothly through 0, 22.5, 45, 67.5, 90, 112.5, 135, and 157.5 degrees.",
        "Change only gaze, head turn, and the minimum upper-body rotation needed to read the direction.",
        "Keep body scale, baseline, identity, markings, palette, material, and props stable.",
    ],
    "look-180-337-5": [
        "Treat the frames as ordered directional poses, not an animation loop.",
        "Progress smoothly through 180, 202.5, 225, 247.5, 270, 292.5, 315, and 337.5 degrees.",
        "Change only gaze, head turn, and the minimum upper-body rotation needed to read the direction.",
        "Keep body scale, baseline, identity, markings, palette, material, and props stable.",
    ],
}
...
def default_output_dir(pet_id: str) -> Path:
    ...
    return Path.cwd() / "output" / "make-codex-pet-v2" / f"{pet_id}-{timestamp}"
